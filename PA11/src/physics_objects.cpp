...
btCollisionShape * PhysicsObject::GetCollisionShape(struct PhysicsOptions physics)
{
    switch(physics.colliderType)
    {
        ...
        case ColliderType::Sphere:
                return new btSphereShape(btScalar(.4f));
                break;

        case ColliderType::Cube:
                return new btBoxShape(0.3f * btVector3(1.0f, 1.0f, 1.0f));
                break;

        case ColliderType::Cylinder:
                return new btCylinderShape(0.3f * btVector3(1.0f, 1.0f, 1.0f));
                break;

        case ColliderType::Mesh:
                return new btBvhTriangleMeshShape(objTriMesh, true);
                break;
        case ColliderType::CarCube:
                return new btBoxShape(btVector3(2.0f, 0.5f, 3.0f));
    }
